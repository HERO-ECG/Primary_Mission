...
void Yaw_Init(void)
{
	...
	Tripod.Yaw.PID_speed.p=80;//120;//200
	Tripod.Yaw.PID_speed.i=0.75;//2;
...
void Pitch_Init(void)
{
	...
	Tripod.Pitch.PID_speed.p=80;//95;//200
	...
	Tripod.Pitch.PID2_angle.p=7.5;//15
