...
#define len_uart2_rx_buff 7	
#define len_uart3_rx_buff 11u	
#define len_uart6_rx_buff 44	
#define len_uart8_rx_buff 48
#define len_uart8_tx_buff 20	 
...
extern uint8_t uart8_tx_buff[len_uart8_tx_buff]; 
