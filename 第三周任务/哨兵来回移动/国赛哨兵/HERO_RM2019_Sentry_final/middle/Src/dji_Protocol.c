...
void CapacitanceStatesTransmit(uint8_t CapacitanceStates)
{
	...
	FrameAllMessage[5] = 0x01;
	FrameAllMessage[6] = 0x03;
	
	FrameAllMessage[7] = 0x80;
	FrameAllMessage[8] = 0xD1;
	FrameAllMessage[9] = 0x03;
	FrameAllMessage[10]= 0;
	FrameAllMessage[11]= 0x03;
	FrameAllMessage[12]= 0x01;
	...
	FrameAllMessage[26] = tempcrc16 & 0x00ff;
