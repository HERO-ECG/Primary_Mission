...
{		
	...
	RC_CtrlData->key.key_data.R=(RC_CtrlData->key.v&0x0100)==0x0100;//自瞄吊射
	RC_CtrlData->key.key_data.F=(RC_CtrlData->key.v&0x0200)==0x0200;
	RC_CtrlData->key.key_data.G=(RC_CtrlData->key.v&0x0400)==0x0400;//换向
	...
	RC_CtrlData->key.key_data.V=(RC_CtrlData->key.v&0x4000)==0x4000;//自瞄小弹丸
	RC_CtrlData->key.key_data.B=(RC_CtrlData->key.v&0x8000)==0x8000;//自瞄大弹丸

		if((RC_CtrlData->key.key_data.C==1)&&(RC_CtrlData->key.key_data_last.C==0)) 
			RC_CtrlData->key.key_state.C=!RC_CtrlData->key.key_state.C;//连发模式变换
		RC_CtrlData->key.key_data_last.C = RC_CtrlData->key.key_data.C;	
		if((RC_CtrlData->key.key_data.F==1)&&(RC_CtrlData->key.key_data_last.F==0)) 
			RC_CtrlData->key.key_state.F=!RC_CtrlData->key.key_state.F;//自瞄修正
		RC_CtrlData->key.key_data_last.F = RC_CtrlData->key.key_data.F;	
...
void RCDataParaInit(RC_Ctl_t *RC_CtrlData){
	...
	RCReadKey(RC_CtrlData);	
//	RC_CtrlData->key.key_data.W = RC_CtrlData->key.v&0x0001;
//	RC_CtrlData->key.key_data.S = RC_CtrlData->key.v&0x0002;
//	RC_CtrlData->key.key_data.A = RC_CtrlData->key.v&0x0004;
//	RC_CtrlData->key.key_data.D = RC_CtrlData->key.v&0x0008;
//	RC_CtrlData->key.key_data.shift = RC_CtrlData->key.v&0x0010;
//	RC_CtrlData->key.key_data.ctrl = RC_CtrlData->key.v&0x0020;
//	RC_CtrlData->key.key_data.Q = RC_CtrlData->key.v&0x0040;
//	RC_CtrlData->key.key_data.E = RC_CtrlData->key.v&0x0080;
//	RC_CtrlData->key.key_data.R = RC_CtrlData->key.v&0x0100;
//	RC_CtrlData->key.key_data.F = RC_CtrlData->key.v&0x0200;
//	RC_CtrlData->key.key_data.G = RC_CtrlData->key.v&0x0400;
//	RC_CtrlData->key.key_data.Z = RC_CtrlData->key.v&0x0800;
//	RC_CtrlData->key.key_data.X = RC_CtrlData->key.v&0x1000;
//	RC_CtrlData->key.key_data.C = RC_CtrlData->key.v&0x2000;
//	RC_CtrlData->key.key_data.V = RC_CtrlData->key.v&0x4000;
//	RC_CtrlData->key.key_data.B = RC_CtrlData->key.v&0x8000;
}
