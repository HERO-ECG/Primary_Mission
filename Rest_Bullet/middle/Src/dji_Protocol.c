...
//						RoboData->shoot_heat_ctr.nowHeat42 = DJI_ReadData->extPowerHeatData.shooterHeat42;
                ...
                case 0x0202:
                {
                    ...
                    Data [0] = (int16_t)(((int16_t)(DJI_ReadData->ext_power_heat_data.shooter_heat0))>>8);
                    Data [1] = (int16_t)(((int16_t)(DJI_ReadData->ext_power_heat_data.shooter_heat0)));

//										#define one_ammo_heat 16
//                    Chassis.heat.heat_server[1] = Chassis.heat.heat_server[0];
//                    Chassis.heat.heat_server[0] = (int16_t)(Data[0]<<8 | Data[1])/1.0f;
//                    if((Chassis.heat.heat_server[0]-Chassis.heat.heat_server[1]) > 0)
...
void CustomSend(void)//10hz
{
    ...
    if(Chassis.heat.client_ammo_left < 0)
        Chassis.heat.client_ammo_left = 0;
    customdata.fdata[0] = Chassis.heat.client_ammo_left;//剩余弹量
...
void CustomShape_linetest(void)
{
    int i;
    static uint8_t beat;
    u16 tempcrc16;
