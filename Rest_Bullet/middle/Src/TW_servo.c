...
//{
//	CANopen_SendData(&hcan2,TW_COBID_TX,ONE_BYTE_TXLENGTH,CONTROLMODE_W,0,CONTROLMODE_SPEED);
//	HAL_Delay(2);
//}

//void TW_servo_SetPositionMode(void)
//{
//	CANopen_SendData(&hcan2,TW_COBID_TX,ONE_BYTE_TXLENGTH,CONTROLMODE_W,0,CONTROLMODE_POSITION);
//	HAL_Delay(2);
//}
...
//		CANopen_SendData(&hcan2,TW_COBID_TX,ONE_BYTE_TXLENGTH,CONTROLMODE_W,0,POSITIONMODE_ABSOLUTE);
//	else
//		CANopen_SendData(&hcan2,TW_COBID_TX,TWO_BYTE_TXLENGTH,CONTROLWORD,0,POSITIONMODE_RELATIVE);
//	
//	HAL_Delay(2);
//}
...
//{
//	CANopen_SendData(&hcan2,TW_COBID_TX,TWO_BYTE_TXLENGTH,CONTROLWORD,0,QUICKSTOP);

//}

//void TW_servo_SetPosition(s32 move)
//{
//	CANopen_SendData(&hcan2,TW_COBID_TX, FOUR_BYTE_TXLENGTH,POSITION_W, 0x00,move);
//}
//	

//void TW_servo_GetPosition(void)
//{
//	CANopen_SendData(&hcan2,TW_COBID_TX,READ,POSITION_R,0x00,0);
//}

//void TW_servo_GetSpeed(void)
//{
//	CANopen_SendData(&hcan2,TW_COBID_TX,READ,SPEED_R,0x00,0);
//}

//void TW_servo_GetCurrent(void)
//{
//	CANopen_SendData(&hcan2,TW_COBID_TX,READ,CURRENT_R,0x00,0);
//}
...
//	else
//	{
//		CANopen_SendData(&hcan2,TW_COBID_TX, FOUR_BYTE_TXLENGTH,SPEED_W	, 0x00,speed);
//	}
//}
//	
...
//	{
//		TW_servo.init_cnt++;
//		if((TW_servo.init_cnt>20)&&(TW_servo.offset_angle != 0))
